...
export default function SidebarAdmin({
    ...
    return (
        <>
            ...
            <aside
                className={`w-64 h-screen bg-gray-100 border-r-2 border-slate-400 border-solid transform transition-transform duration-300 ease-in-out flex flex-col flex-shrink-0 z-50 fixed left-0 top-0 overflow-y-auto 
            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-6 border-b border-gray-100">
                    ...
                    <button
                        className="md:hidden p-1 text-gray-500 hover:text-red-600 transition-colors"
                        onClick={() => setIsOpen(false)}
                    >
                        <X size={24} />
                    </button>
                ...
                <div className="p-4 border-t border-gray-200">
                    <button
                        className="flex w-full items-center gap-3 px-3 py-2 text-sm font-semibold text-red-700 border-2 border-red-700 hover:bg-red-700 hover:text-white rounded-lg transition-colors"
