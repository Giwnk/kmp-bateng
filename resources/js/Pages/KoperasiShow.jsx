        ...
        <div className="p-10">
            ...
            <div className="mb-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    ...
                    <Link
                        href={route("kecamatan.show", koperasi.kecamatan_id)}
                        className="text-gray-500 hover:text-gray-800 font-medium text-sm border px-4 py-2 rounded-lg bg-white"
                    >
                        &larr; Kembali
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition">
                        ...
                        <p className="text-2xl font-bold text-gray-800">
                            {koperasi.anggota_koperasis_count || 0}{" "}
                            <span className="text-sm font-medium text-gray-400">
                                Orang
                            </span>
                        </p>
